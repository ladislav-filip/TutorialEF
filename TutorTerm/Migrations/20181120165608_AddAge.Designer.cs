...
namespace TutorTerm.Migrations
{
    ...
    [Migration("20181120165608_AddAge")]
            ...
            modelBuilder.Entity("TutorTerm.DAL.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = 1, Active = "T", Age = (short)0, GenderId = (byte)1, LanguageId = (short)3, Name = "Petr", Surname = "Veliký" },
                        new { UserId = 2, Active = "T", Age = (short)0, GenderId = (byte)2, LanguageId = (short)4, Name = "Alžběta", Surname = "Druhá" },
                        new { UserId = 3, Active = "T", Age = (short)0, GenderId = (byte)1, LanguageId = (short)1, Name = "Karel", Surname = "Čtrvtý" }
                    );
                });
